...
## Task 15
exclude_zero_list = [(a, b, c) for a in S for b in S for c in S if a+b+c==0 and not (a == 0 and b == 0 and c == 0)] 

## Task 16
first_of_tuples_list = [(a, b, c) for a in S for b in S for c in S if a+b+c==0 and not (a == 0 and b == 0 and c == 0)][0]
...
k = 'Frodo'
value_list_modified_2 = [d.get(k, 'NOT PRESENT') for d in dlist] # <-- as you do here
...
listdict2dict = {names[i]:salary for i, salary in d.items()}
